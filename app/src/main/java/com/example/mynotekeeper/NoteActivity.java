...
public class NoteActivity extends AppCompatActivity {
    public static final String NOTE_POSITION ="com.example.mynotekeeper.NOTE_POSITION";
    ...
    private void sendEmail() {
        ...
        String text = "Check out what I learn't in the pluralsight course " + course.getTitle() + "\n"+ mTextNoteText.getText();
